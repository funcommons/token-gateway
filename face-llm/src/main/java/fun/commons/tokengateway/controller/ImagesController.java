...
/**
 * OpenAI Images Generations 端点 (WebFlux 原生).
 *
 * <p>路径: POST /v1/images/generations
...
public class ImagesController {
    ...
    private static final String REQUEST_PATH = "/v1/images/generations";
    private static final String UPSTREAM_ENDPOINT = "/v1/images/generations";
    ...
    private Mono<Map<String, Object>> invokeUpstream(DistributeVO channel, Map<String, Object> body) {
        ...
        return webClientBuilder.build().post()
                ...
                .onErrorResume(e -> {
                    log.error("[Images] 上游调用失败 url={}, err={}", url, e.getMessage());
                    return Mono.error(new RelayException(502, "upstream failed: " + e.getMessage()));
                });
    }

    private static int estimateFromPrompt(Map<String, Object> body) {
