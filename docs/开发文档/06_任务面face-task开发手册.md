...
| 配套 | 《05》方案权威；《05_任务面接入手册》/《09_任务面API契约.yaml》caller 契约；《04_后端服务对接安全契约方案》鉴权三式 |
| 版本 | V1.0（2026-09-01） |
...
| # | 项 | 建议默认 |
|---|---|---|
| 1 | ~~租户开通 runbook~~ **已落地（2026-09-02）**：《07_lotask4j租户开通手册》（建租户/secret 三变量同源/task_type 注册/轮换/冒烟拉起/故障速查） | — |
